...
class App extends Component {
  ...
  render() {
    const footer = (
      <div>
        <Button label="CONTINUE EXPLORING" icon="pi pi-check" onClick={this.onHide} className="p-button-raised" />
        <Button label="LOGOUT" icon="pi pi-times" onClick={this.logout} className="p-button-secondary p-button-raised" />
      </div>
    );
          ...
          <div className="App">
            ...
            <nav className="navbar navbar-expand-md bg-dark navbar-dark">
              <div className="navbar-header">
                <Link className="navbar-brand" to="/home">Start Wandering</Link>
              </div>
              <ul className="navbar-nav ml-auto">
                ...
                {this.state.logged_userId ?
                  <li className="nav-item">
                    <button className="nav-link btn" onClick={this.confirm_logout}>Logout</button>
                  </li> : null}
              </ul>
            </nav>
